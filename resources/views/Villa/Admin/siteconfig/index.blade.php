        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="container ">
                    <div class="row">
                        <div class="col">
                             <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Site Configs/</span> Index </h4>
                        </div>
                        <div class="col text-end pt-2">
                            <a href="{{ route('siteconfig.create') }}" class="btn btn-primary btn-m py-2  "> Add <i class="fa fa-plus"
                            ...
                            <tbody class="table-border-bottom-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route ('siteconfig.edit' , $siteconfig->id)}}" class="btn btn-sm btn-primary"> Edit </a>
                                        <a href="{{ route ('siteconfig.show' , $siteconfig->id)}}" class="btn btn-sm btn-warning"> Show </a>
                                            ...
                                            <div class="modal-dialog        ">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{route('siteconfig.destroy', $siteconfig->id)}}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('delete')
