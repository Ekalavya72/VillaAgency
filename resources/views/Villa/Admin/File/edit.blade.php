...
<div class="content-wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">File/</span> edit
                </h4>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="basic-icon-default-fullname" placeholder="Title" aria-label="Title" 
                                        aria-describedby="basic-icon-default-fullname2" name="title"
                                        value="{{ $file -> title }}">
                                    </div>
                                </div>
                            </div>
