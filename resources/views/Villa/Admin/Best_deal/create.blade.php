        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Create Best Deals</h5>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" class="form-control" id="basic-icon-default-area" placeholder="area" aria-label="area" aria-describathby="basic-icon-default-area" name="total_flat_space" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" class="form-control" id="basic-icon-default-floor" placeholder="floor" aria-label="floor" aria-describedby="basic-icon-default-floor" name="floor_number" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" class="form-control" id="basic-icon-default-bedrooms" placeholder="bedrooms" aria-label="bedrooms" aria-describedby="basic-icon-default-bedrooms" name="number_of_rooms" />
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row align-items-center mx-0">
                                        <div class="col-auto pe-2 m-2 ">
                                            <div class="form-check form-check-inline m-n3">
                                                <input class="form-check-input" type="radio" name="parking_available" id="parkingYes" value="Yes">
                                                <label class="form-check-label" for="parkingYes">Yes</label>
                                            </div>
                                        </div>
                                        <div class="col-auto ">
                                            <div class="form-check form-check-inline m-0">
                                                <input class="form-check-input" type="radio" name="parking_available" id="parkingNo" value="No">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="basic-icon-default-additional_info" class="form-control" placeholder="additional_info of the property" aria-label="Hi, Do you have a moment to talk Joe?" aria-describedby="basic-icon-default-additional_info" name="additional_info" rows="2" cols="30"></textarea>
                                </div>
                            </div>
                        </div>
