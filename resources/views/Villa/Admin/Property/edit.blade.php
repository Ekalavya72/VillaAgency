...
<div class="container">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Property/</span>Edit</h4>
            <!-- Basic Layout & Basic with Icons -->
            <!-- Basic with Icons -->
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Edit Property Details</h5>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    aria-describedby="basic-icon-default-address" name="address" value="{{ $property-> address }}"/>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" class="form-control" id="basic-icon-default-price" placeholder="price" aria-label="price"
                                     aria-describedby="basic-icon-default-price" name="price" value="{{ $property-> price}}"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    aria-describedby="basic-icon-default-bedrooms" name="bedrooms"  value="{{ $property-> bedrooms}}"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    aria-describathby="basic-icon-default-bathrooms" name="bathrooms"  value="{{ $property-> bathrooms}}"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    aria-describathby="basic-icon-default-area" name="area"   value="{{ $property-> area}}"/>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    aria-describedby="basic-icon-default-floor" name="floor"  value="{{ $property-> floor}}" />
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    aria-describedby="basic-icon-default-parking" name="parking"  value="{{ $property-> parking}}"/>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <textarea id="basic-icon-default-description" class="form-control" placeholder="description of the property"
                                                aria-label="Hi, Do you have a moment to talk Joe?" aria-describedby="basic-icon-default-description" name="description" rows="2" cols="30">  {{ $property-> description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group mb-3 col">
                                        ...
                                        <input id="imagebox" type="text" class="form-control" name="img"
                                            @readonly('true') value="{{ $property->img }}">
                                    ...
                                    <a href="{{ asset('uploads/' . $property->img) }}" target="_blank">
                                        <img src="{{ asset('uploads/' . $property->img) }}" alt="img" width="50px"
                                            height="50px">
                                    </a>
                                    <div class="mb-3">
